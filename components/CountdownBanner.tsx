      ...
      <div className="w-full max-w-full flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 text-xs sm:text-sm font-medium">
        ...
        {lumaUrl && (
          <a
            ...
            className="inline-block px-4 py-1.5 text-xs sm:text-sm bg-black text-white dark:bg-white dark:text-black rounded-lg hover:opacity-80 transition-opacity font-medium whitespace-nowrap flex-shrink-0"
          >
            Register
          </a>
        )}
